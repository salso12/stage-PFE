...
$CODEORDRE = $_GET['CODEORDRE'];
$student = find($CODEORDRE);
...
<body>
  ...
  <div class="container2">  
    <form id="contact" action="update-ordre.php" method="post">
    
    <input type="hidden" name="CODEORDRE" value="<?=$student['CODEORDRE'] ?>">

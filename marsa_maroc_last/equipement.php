...
{
  $desi =  $_REQUEST['desi'];
  $sql = "select * from equipement where DESIGNATION='$desi'";
$result = mysqli_query($con,$sql);
$row = mysqli_fetch_assoc($result);
  $etat = $_REQUEST['etatequi'];
  $sql = "update equipement set DISPONIBILITES='$etat' where DESIGNATION='$desi'";
  $result = mysqli_query($con,$sql);
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col">SOUSFAMILE</th>
                <th scope="col">MARQUE</th>
                <th scope="col">TYPE</th>
                <th scope="col">DATE MIS EN SERVISE</th>
        ...
        <tbody>
          ...
          while($row = mysqli_fetch_assoc($result))
          {
            ...
            <td>
            <input type='hidden' name='desi' value='".$row["DESIGNATION"]."'>

            <select class='form-control custom' name='etatequi'>
            <option >".$row["DISPONIBILITES"]."</option> 
            <br/>
